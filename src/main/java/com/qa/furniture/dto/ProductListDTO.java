...
public class ProductListDTO {
	...
	public ProductListDTO(String availability,double categoryId,String color,String createdOn,String description,double discount,String materialDescription,String name,double price,String updateOn,double warranty) {
	...
	public void setAvailibility (String availability) {
